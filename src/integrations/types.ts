...
export type IntegrationKind = 'framer' | 'gsc' | 'ga4' | 'dataforseo' | 'pexels' | 'ahrefs' | 'surfer'

export const KNOWN_INTEGRATIONS: IntegrationKind[] = ['framer', 'gsc', 'ga4', 'dataforseo', 'pexels', 'ahrefs', 'surfer']
